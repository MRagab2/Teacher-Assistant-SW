    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["stuID"])){
            ...
            if($studentController->deleteStudentData($st)){
                $student = $studentController->viewAll3rdStudentData();
            ...
            <li class="nav-item active">
                ...
                <div id="collapse3rd" class="collapse show" aria-labelledby="heading3rd" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="3rd Data.php">Data</a>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">3rd Sec Data</h6>
                                    <a href="3rd Data Add.php?class=3rd%20sec" class="btn btn-primary btn-icon-split"><span class="icon text-white"><i class="fa fa-user-plus"></i>
                                    ...
                                    <tbody>
                                        ...
                                        ?>  
                                            <tr>
                                                ...
                                                <td><?= $st['school'] ?></td>
                                                <td>
                                                    <form action="3rd Data Edit.php" method="GET">
                                                        <input type="hidden" name="stuID" value= "<?php $_SESSION['stuID'] = $st['id']; echo $st['id']?>">
                                                    ...
                                                    if(isset($_GET['DEL'])){
                                                        if($_GET['DEL']==1){
                                                    ?>
                                                    <form action="3rd Data.php?DEL=2" method="POST" >                                                        
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="3rd Data.php?DEL=1" method="POST" >
                                                                <input type="hidden" name="stuID" value= "<?= $st['id']?>">
                                                                <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                            </form>
                                                        <?php
