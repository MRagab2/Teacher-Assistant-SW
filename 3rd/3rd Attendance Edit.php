...
$studentView = $studentController->viewAll3rdStudentAttendance();
$studentEntry = $studentController->viewAll3rdStudentAttendance();
...
<head>
    ...
    <title>3rd sec Edit '<?= $student->day ?>' Attendance</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="3rd Attendance Edit.php?dayDate=<?= $student->day ?>&edit=1">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="3rd Attendance.php" class="d-none d-sm-inline-block btn btn-google shadow-sm">
