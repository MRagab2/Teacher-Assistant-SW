...
$studentView = $studentController->viewAll3rdStudentExams();
$studentEntry = $studentController->viewAll3rdStudentExams();
...
<head>
    ...
    <title>3rd sec Edit '<?= $student->num ?>' Exam</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="3rd Exams Edit.php?examNum=<?= $student->num ?>&edit=1">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="3rd Exams.php" class="d-none d-sm-inline-block btn btn-google shadow-sm">
