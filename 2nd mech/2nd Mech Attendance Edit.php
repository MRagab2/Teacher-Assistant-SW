...
$studentView = $studentController->viewAll2ndMechStudentAttendance($center);
$studentEntry = $studentController->viewAll2ndMechStudentAttendance($center);
...
if($_GET['edit']){
    header("location: 2nd Mech Attendance.php?place=$center");
}
...
<head>
    ...
    <title>2nd sec Mech Edit '<?= $student->day ?>' Attendance</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2nd" class="collapse show" aria-labelledby="heading2nd" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="2nd Mech Attendance.php?place=Helwan">Attendance</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2ndM" class="collapse show" aria-labelledby="heading2ndM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"        href="2nd Mech Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item"        href="2nd Mech HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item active" href="2nd Mech Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item"        href="2nd Mech Exams.php?place=Mayo">Exams</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="2nd Mech Attendance Edit.php?dayDate=<?= $student->day ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="2nd Mech Attendance.php?place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
