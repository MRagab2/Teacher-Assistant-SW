    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["examNum"])){
            ...
            if($studentController->deleteStudentExam($st)){
                $student = $studentController->viewAll2ndMechStudentExams($center);
                header("location: 2nd Mech Exams.php?place=$center");
            }
        }
        $_GET['DEL'] = 0;
    }
...
<head>
    ...
    <title>2nd Sec Mech Exams</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2nd" class="collapse show" aria-labelledby="heading2nd" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="2nd Mech Exams.php?place=Helwan">Exams</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2ndM" class="collapse show" aria-labelledby="heading2ndM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"        href="2nd Mech HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item"        href="2nd Mech Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item active" href="2nd Mech Exams.php?place=Mayo">Exams</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">2nd Sec Mech Exams</h6>
                                    <a href="2nd Mech Exams Add.php?place=<?=$center?>" class="btn btn-primary btn-icon-split"><span class="icon text-white">                                        <i class="fas fa-plus-circle"></i></span><span class="text"> New Exam</a>
                            </div>
                        </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            foreach($exams as $ex){
                                                ?>
                                                <th>
                                                    <form action="2nd Mech Exams Edit.php?examNum=<?=$ex['0']?>&place=<?=$center?>&edit=" method="POST">
                                                        <input type="hidden">
                                                    ...
                                                    if(isset($_GET['CLR'])){
                                                        if($_GET['CLR']==1){
                                                    ?>
                                                        <form action="2nd Mech Exams.php?CLR=2&place=<?=$center?>" method="POST">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="2nd Mech Exams.php?CLR=1&place=<?=$center?>" method="POST">
                                                                <input type="hidden" name="examNum" value= "<?= $ex['0']?>">
                                                                <button type="submit" name="clr" class="btn btn-warning btn-user btn-block"> Clear</button>
                                                            </form>
                                                            <?php
                                                    ...
                                                    if(isset($_GET['DEL'])){
                                                        if($_GET['DEL']==1){
                                                    ?>
                                                    <form action="2nd Mech Exams.php?DEL=2&place=<?=$center?>" method="POST" >                                                        
                                                        <input type="hidden" name="examNum" value= "<?= $ex['0']?>">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="2nd Mech Exams.php?DEL=1&place=<?=$center?>" method="POST" >
                                                                <input type="hidden" name="examNum" value= "<?= $ex['0']?>">
                                                                <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                            </form>
                                                        <?php
