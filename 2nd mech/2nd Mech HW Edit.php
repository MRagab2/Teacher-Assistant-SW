...
$studentView = $studentController->viewAll2ndMechStudentHW($center);
$studentEntry = $studentController->viewAll2ndMechStudentHW($center);
...
<head>
    ...
    <title>2nd sec Mech Edit '<?= $student->day ?>' HomeWork</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="2nd Mech HW Edit.php?dayDate=<?= $student->day ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="2nd Mech HW.php&place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
