    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["dayDate"])){
            ...
            if($studentController->deleteStudentAttendance($st)){
                $student = $studentController->viewAll2ndMechStudentAttendance($center);
...
<head>
    ...
    <title>2nd Sec Mech Attendance</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">2nd Sec (Mech) Attendance</h6>
                                    <a href="2nd Mech Attendance Add.php?place=<?=$center?>" class="btn btn-primary btn-icon-split"><span class="icon text-white">                                        <i class="fas fa-plus-circle"></i></span><span class="text"> New Day</a>
                            </div>
                        </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            foreach($days as $d){
                                                ?>
                                                <th>
                                                    <form action="2nd Mech Attendance Edit.php?dayDate=<?=$d['0']?>&place=<?=$center?>&edit=" method="POST">
                                                        <input type="hidden">
                                                    ...
                                                    if(isset($_GET['CLR'])){
                                                        if($_GET['CLR']==1){
                                                    ?>
                                                        <form action="2nd Mech Attendance.php?CLR=2&place=<?=$center?>" method="POST">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="2nd Mech Attendance.php?CLR=1&place=<?=$center?>" method="POST">
                                                                <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                                <button type="submit" name="clr" class="btn btn-warning btn-user btn-block"> Clear</button>
                                                            </form>
                                                            <?php
                                                    ...
                                                    if(isset($_GET['DEL'])){
                                                        if($_GET['DEL']==1){
                                                    ?>
                                                    <form action="2nd Mech Attendance.php?DEL=2&place=<?=$center?>" method="POST" >                                                        
                                                        <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="2nd Mech Attendance.php?DEL=1&place=<?=$center?>" method="POST" >
                                                                <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                                <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                            </form>
                                                        <?php
