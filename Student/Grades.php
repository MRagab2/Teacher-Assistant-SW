...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="Student Data.php">
                    <i class="fa fa-users"></i>
                    <span>Student Data</span></a>
            </li>

            <li class="nav-item <?= $_SESSION['grade_type']=='attendance'?'active':''?>">
                <a class="nav-link" href="?goto=attendance">
                    <i class="fa fa-users"></i>
                    <span>Student Attendance</span></a>
            </li>

            <li class="nav-item <?= $_SESSION['grade_type']=='quiz_grade'?'active':''?>">
                <a class="nav-link" href="?goto=quiz">
                    <i class="fa fa-users"></i>
                    <span>Student Quizzes</span></a>
            </li>

            <li class="nav-item <?= $_SESSION['grade_type']=='hw_grade'?'active':''?>">
                <a class="nav-link" href="?goto=hw">
                    <i class="fa fa-users"></i>
                    <span>Student HomeWorks</span></a>
            </li>

            <li class="nav-item <?= $_SESSION['grade_type']=='exam_grade'?'active':''?>">
