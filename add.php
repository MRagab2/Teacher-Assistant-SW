                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <select id="yearList" title="Class" onchange="updateBranchList()"
                                    style=" width: 30%;
                                            font-size: 16px;
                                            padding: 12px 20px 12px 40px;
                                            border: 1px solid #ddd;
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="d-flex flex-row">
                                    ...
                                    id="questions" oninput="updateQuizRows()"
                                    style=" width: 65px;
                                            font-size: 16px;
                                            padding-left: 20px;
                                            border: 1px solid #ddd;
                                ...
                                <table class="table table-bordered" id="quiz_questions" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Branch</th>
                                            <th>Book</th>
