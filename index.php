    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["stuID"])){
            ...
            if($studentController->deleteStudentData($st)){
                $studentH = $studentController->viewAllStudentDataHelwan();
                $studentM = $studentController->viewAllStudentDataMayo();
                        ...
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">Students Data</h6>
                                    <a href="Student Data Add.php" class="btn btn-primary btn-icon-split"><span class="icon text-white">
                                        <i class="fa fa-user-plus"></i></span><span class="text"> New Student</a>
                            </div>
                        </div>
                                        ...
                                        ?>  
                                            <tr>
                                                ...
                                                <td>
                                                          ...
                                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-footer">
                                                                ...
                                                                <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="Student Details.php?stID=<?= $st['id'] ?>&class=<?= $st['class'] ?>&subClass=Math">
                                                                    Mathematics</a>
                                                                <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="Student Details.php?stID=<?= $st['id'] ?>&class=<?= $st['class'] ?>&subClass=Mech">
                                                                    Mechanics</a>
                                                              </div>
                                                            </div>
                                                          </div>
                                                    ...
                                                    ?>
                                                        <a href="Student Details.php?stID=<?= $st['id'] ?>&class=<?= $st['class'] ?>&subClass=<?= $st['lec'] ?>">
                                                            <?= $st['name'] ?></a>
                                                    <?php
                                                    }
                                                    ?>
