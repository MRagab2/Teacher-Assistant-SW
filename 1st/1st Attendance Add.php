...
if(isset($_POST['date'])){
    if(!empty($_POST['date'])){
        ...
        if($studentController->newStudentAttendance($stu)){
            foreach($STUDENT as $ST){
                if(!empty($_POST[$ST['id'].'a'])){

                    $stu->name  = $ST['name'];
                    $stu->id    = $ST['id'];                
                    $stu->grade = trim($_POST[$ST['id'].'a']);

                    if(!$studentController->newStudentAttendanceDay($stu)){
                        break ;  
                    }
                }
            }
...
<head>
    ...
    <title>1st sec taking attendance</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="1st Attendance Add.php?place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Taking Attendance...</h6>
