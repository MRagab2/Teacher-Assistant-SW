    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["stuID"])){
            ...
            if($studentController->deleteStudentData($st)){
                $student = $studentController->viewAll1stStudentData($center);
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stH" class="collapse show" aria-labelledby="heading1stH" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="1st Data.php?place=Helwan">Data</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stM" class="collapse show" aria-labelledby="heading1stM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="1st Data.php?place=Mayo">Data</a>
                        <a class="collapse-item"        href="1st Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item"        href="1st HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item"        href="1st Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item"        href="1st Exams.php?place=Mayo">Exams</a>                        
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">1st Sec Data</h6>
                                    <a href="1st Data Add.php?place=<?=$center?>" class="btn btn-primary btn-icon-split"><span class="icon text-white"><i class="fa fa-user-plus"></i>
                                    ...
                                    <tbody>
                                        ...
                                        ?>  
                                            <tr>
                                                <td><?= $st['id'] ?></td>
                                                <td>
                                                    <a href="../Student Details.php?stID=<?= $st['id'] ?>&class=<?= $st['class'] ?>&subClass=">
                                                            <?= $st['name'] ?></a>
                                                </td>
                                                <td><?= $st['person num'] ?></td>
                                                ...
                                                <td><?= $st['school'] ?></td>
                                                <td>
                                                <form action="1st Data Edit.php?stuID=<?=$st['id']?>&place=<?=$center?>&edit=" method="POST">
                                                    <input type="hidden">
                                                    <button type="submit" class="btn btn-info btn-user btn-block" ><i class="fas fa-user-edit"></i></button>
                                                </form>
                                                <hr>
                                                ...
                                                if(isset($_GET['DEL'])){
                                                    if($_GET['DEL']==1){
                                                ?>
                                                <form action="1st Data.php?DEL=2&place=<?=$center?>" method="POST" >                                                        
                                                ...
                                                <?php
                                                        ...
                                                        ?>
                                                        <form action="1st Data.php?DEL=1&place=<?=$center?>" method="POST" >
                                                            <input type="hidden" name="stuID" value= "<?= $st['id']?>">
                                                            <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                        </form>
                                                    <?php
