...
if(isset($_POST["del"])){
    if($_GET['DEL']==2){
        if(!empty($_POST["dayDate"])){
            ...
            if($studentController->deleteStudentHW($st)){
                $student = $studentController->viewAll1stStudentHW($center);
                header("location: 1st HW.php?place=$center");
            }
        }
        $_GET['DEL'] = 0;
    }
...
if(isset($_POST["clr"])){
    if($_GET['CLR']==2){
        if(!empty($_POST["dayDate"])){
            ...
            if($studentController->nullStudentHW($st)){
                $student = $studentController->viewAll1stStudentHW($center);
                header("location: 1st HW.php?place=$center");
            }
        }
...
$days = $studentController->viewAll1stHW($center);
$student = $studentController->viewAll1stStudentHW($center);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link " href="#" data-toggle="collapse" data-target="#collapse1stH"
                    aria-expanded="true" aria-controls="collapse1stH">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>1st sec (Helwan)</span>
                </a>
                <div id="collapse1stH" class="collapse show" aria-labelledby="heading1stH" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"        href="1st Data.php?place=Helwan">Data</a>
                        <a class="collapse-item"        href="1st Quizzes.php?place=Helwan">Quizzes</a>
                        <a class="collapse-item active" href="1st HW.php?place=Helwan">HomeWork</a>
                        <a class="collapse-item"        href="1st Attendance.php?place=Helwan">Attendance</a>
                        <a class="collapse-item"        href="1st Exams.php?place=Helwan">Exams</a>                        
                    </div>
                </div>
            </li> 
            ...
            <li class="nav-item">
                ...
                <div id="collapse1stM" class="collapse" aria-labelledby="heading1stM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="1st Data.php?place=Mayo">Data</a>
                        <a class="collapse-item" href="1st Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item" href="1st HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item" href="1st Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item" href="1st Exams.php?place=Mayo">Exams</a>                        
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse1stH" class="collapse" aria-labelledby="heading1stH" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="1st Data.php?place=Helwan">Data</a>
                        <a class="collapse-item" href="1st Quizzes.php?place=Helwan">Quizzes</a>
                        <a class="collapse-item" href="1st HW.php?place=Helwan">HomeWork</a>
                        <a class="collapse-item" href="1st Attendance.php?place=Helwan">Attendance</a>
                        <a class="collapse-item" href="1st Exams.php?place=Helwan">Exams</a>                        
                    </div>
                </div>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item active">
                <a class="nav-link " href="#" data-toggle="collapse" data-target="#collapse1stM"
                    aria-expanded="true" aria-controls="collapse1stM">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>1st sec (Mayo)</span>
                </a>
                <div id="collapse1stM" class="collapse show" aria-labelledby="heading1stM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"        href="1st Data.php?place=Mayo">Data</a>
                        <a class="collapse-item"        href="1st Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item active" href="1st HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item"        href="1st Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item"        href="1st Exams.php?place=Mayo">Exams</a>                        
                    </div>
                </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">1st Sec HomeWork</h6>
                                    <a href="1st HW Add.php?place=<?=$center?>" class="btn btn-primary btn-icon-split"><span class="icon text-white">                                        <i class="fas fa-plus-circle"></i></span><span class="text"> New Day</a>
                            </div>
                        </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            foreach($days as $d){
                                                ?>
                                                <th>
                                                    <form action="1st HW Edit.php?dayDate=<?=$d['0']?>&place=<?=$center?>&edit=" method="POST">
                                                        <input type="hidden">
                                                        <button type="submit" class="btn btn-info btn-user btn-block"><i class="fas fa-edit"></i></button>
                                                    </form>
                                                    <hr>
                                                    <?php
                                                    if(isset($_GET['CLR'])){
                                                        if($_GET['CLR']==1){
                                                    ?>
                                                        <form action="1st HW.php?CLR=2&place=<?=$center?>" method="POST">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="1st HW.php?CLR=1&place=<?=$center?>" method="POST">
                                                                <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                                <button type="submit" name="clr" class="btn btn-warning btn-user btn-block"> Clear</button>
                                                            </form>
                                                            <?php
                                                    ...
                                                    if(isset($_GET['DEL'])){
                                                        if($_GET['DEL']==1){
                                                    ?>
                                                    <form action="1st HW.php?DEL=2&place=<?=$center?>" method="POST" >                                                        
                                                        <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="1st HW.php?DEL=1&place=<?=$center?>" method="POST" >
                                                                <input type="hidden" name="dayDate" value= "<?= $d['0']?>">
                                                                <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                            </form>
                                                        <?php
