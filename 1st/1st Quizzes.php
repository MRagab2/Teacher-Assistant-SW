    ...
    if($_GET['DEL']==2){
        if(!empty($_POST["quizDate"])){
            ...
            if($studentController->deleteStudentQuizz($st)){
                $student = $studentController->viewAll1stStudentQuizzes($center);
                header("location: 1st Quizzes.php?place=$center");
            }
        }
        $_GET['DEL'] = 0;
    }
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stH" class="collapse show" aria-labelledby="heading1stH" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="1st Quizzes.php?place=Helwan">Quizzes</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stM" class="collapse show" aria-labelledby="heading1stM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"        href="1st Data.php?place=Mayo">Data</a>
                        <a class="collapse-item active" href="1st Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item"        href="1st HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item"        href="1st Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item"        href="1st Exams.php?place=Mayo">Exams</a>                        
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">1st Sec Quizzes</h6>
                                    <a href="1st Quizzes Add.php?place=<?=$center?>" class="btn btn-primary btn-icon-split"><span class="icon text-white">                                        <i class="fas fa-plus-circle"></i></span><span class="text"> New Quiz</a>
                            </div>
                        </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            foreach($quizzes as $q){
                                                ?>
                                                <th>
                                                    <form action="1st Quizzes Edit.php?quizDate=<?= $q['0']?>&place=<?=$center?>&edit=" method="POST">
                                                        <input type="hidden">
                                                    ...
                                                    if(isset($_GET['CLR'])){
                                                        if($_GET['CLR']==1){
                                                    ?>
                                                        <form action="1st Quizzes.php?CLR=2&place=<?=$center?>" method="POST">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="1st Quizzes.php?CLR=1&place=<?=$center?>" method="POST">
                                                                <input type="hidden" name="quizDate" value= "<?= $q['0']?>">
                                                                <button type="submit" name="clr" class="btn btn-warning btn-user btn-block"> Clear</button>
                                                            </form>
                                                            <?php
                                                    ...
                                                    if(isset($_GET['DEL'])){
                                                        if($_GET['DEL']==1){
                                                    ?>
                                                    <form action="1st Quizzes.php?DEL=2&place=<?=$center?>" method="POST" >                                                        
                                                        <input type="hidden" name="quizDate" value= "<?= $q['0']?>">
                                                    ...
                                                    <?php
                                                            ...
                                                            ?>
                                                            <form action="1st Quizzes.php?DEL=1&place=<?=$center?>" method="POST" >
                                                                <input type="hidden" name="quizDate" value= "<?= $q['0']?>">
                                                                <button type="submit" name="del" class="btn btn-google btn-user btn-block" ><i class="fas fa-trash-alt"></i></button>
                                                            </form>
                                                        <?php
