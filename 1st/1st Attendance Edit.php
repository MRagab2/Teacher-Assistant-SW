...
$studentView = $studentController->viewAll1stStudentAttendance($center);
$studentEntry = $studentController->viewAll1stStudentAttendance($center);
...
if(isset($_POST["saveEdit"])){
    foreach($studentEntry as $stEntry){
        if(!empty($_POST[$stEntry['id'].'a'])){

            $student->name  = $stEntry['name'];
            $student->id    = $stEntry['id'];
            $student->class = '1st sec';
            $student->grade = $_POST[$stEntry['id'].'a'];

            if(!$studentController->newStudentAttendanceDay($student)){
                break ;  
            }
        }
    }
...
if($_GET['edit']){
    header("location: 1st Attendance.php?place=$center");
}
...
<head>
    ...
    <title>1st sec Edit '<?= $student->day ?>' Attendance</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stH" class="collapse show" aria-labelledby="heading1stH" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="1st Attendance.php?place=Helwan">Attendance</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse1stM" class="collapse show" aria-labelledby="heading1stM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"        href="1st Quizzes.php?place=Mayo">Quizzes</a>
                        <a class="collapse-item"        href="1st HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item active" href="1st Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item"        href="1st Exams.php?place=Mayo">Exams</a>                        
                    </div>
                </div>
            </li> 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="1st Attendance Edit.php?dayDate=<?= $student->day ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit '<?= $student->day ?>' Attendance...</h6>
                                    <button type="submit" class="btn btn-success shadow-sm" name="saveEdit" id="saveEdit">
                                        <i class="fas fa-check-circle"></i> Save
                                    </button>
                                    <a href="1st Attendance.php?place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    $student->class = '1st sec';
                                                    $studentGrade = $studentController->viewStudentAllAttendance($student);
                                                ?>
                                                <td style="color:white; background-color:
                                                        <?php
                                                            if(trim($studentGrade["$student->day"]) == "Yes")
                                                                    echo 'green';
                                                            elseif(trim($studentGrade["$student->day"]) == "No")
                                                                    echo 'red';
                                                                else
                                                                    echo 'white'; 
                                                        ?>
                                                ">                                                                    
                                                    <select  style="border-radius: 25px; width:inherit; height:45px; padding: 10px;"                                                                                                                                        
                                                            name="<?=$stView['id'].'a'?>" id="<?=$stView['id'].'a'?>">
                                                            ...
                                                            <?php
                                                                ...
                                                                if(trim($studentGrade["$student->day"]) == "No"){
                                                            ?>
