...
$stu = new StudentExams;
$stu->center = $center;

if(isset($_POST['examNum'])){
    if(!empty($_POST['examNum'])){
        $stu->num   = $_POST['examNum'];
        $stu->class = '1st sec';
        
        if($studentController->newStudentExam($stu)){
            foreach($STUDENT as $ST){
                if(!empty($_POST[$ST['id'].'e'])){

                    $stu->name  = $ST['name'];
                    $stu->id    = $ST['id'];
                    $stu->grade = trim($_POST[$ST['id'].'e']);

                    if(!$studentController->newStudentExamGrade($stu)){
                        break ;  
                    }
                }
            }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="1st Exams Add.php?place=<?=$center?>">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><input type="text" class="form-control form-control-user"
                                                        id="examNum" name="examNum" required placeholder="Exam #Num"></th>
                                            <?php
                                            foreach($exams as $ex){
                                            ?>
                                                <th><?= $ex['0'] ?></th>
