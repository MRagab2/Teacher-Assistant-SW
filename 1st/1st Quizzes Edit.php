...
$studentView = $studentController->viewAll1stStudentQuizzes($center);
$studentEntry = $studentController->viewAll1stStudentQuizzes($center);
...
<head>
    ...
    <title>1st sec Edit '<?= $student->day ?>' Quiz</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="1st Quizzes Edit.php?quizDate=<?= $student->day ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="1st Quizzes.php?place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
