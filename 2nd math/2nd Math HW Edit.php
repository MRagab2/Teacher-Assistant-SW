...
$studentView = $studentController->viewAll2ndMathStudentHW($center);
$studentEntry = $studentController->viewAll2ndMathStudentHW($center);
...
<head>
    ...
    <title>2nd sec Math Edit '<?= $student->day ?>' HomeWork</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" name="saveEdit" id="saveEdit">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="2nd Math HW Edit.php?dayDate=<?= $student->day ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="2nd Math HW.php?place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
