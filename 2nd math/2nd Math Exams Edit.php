...
$studentView = $studentController->viewAll2ndMathStudentExams($center);
$studentEntry = $studentController->viewAll2ndMathStudentExams($center);
...
if($_GET['edit']){
    header("location: 2nd Math Exams.php?place=$center");
}
...
<head>
    ...
    <title>2nd sec Math Edit '<?= $student->num ?>' Exam</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2nd" class="collapse show" aria-labelledby="heading2nd" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="2nd Math Exams.php?place=Helwan">Exams</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse2ndM" class="collapse show" aria-labelledby="heading2ndM" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"        href="2nd Math HW.php?place=Mayo">HomeWork</a>
                        <a class="collapse-item"        href="2nd Math Attendance.php?place=Mayo">Attendance</a>
                        <a class="collapse-item active" href="2nd Math Exams.php?place=Mayo">Exams</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form method="POST" action="2nd Math Exams Edit.php?examNum=<?= $student->num ?>&edit=1&place=<?=$center?>">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a href="2nd Math Exams.php?place=<?=$center?>" class="d-none d-sm-inline-block btn btn-google shadow-sm">
